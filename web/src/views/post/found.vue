    ...
    <div class="post-container">
      ...
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px" class="post-form">
        ...
        <el-form-item label="拾获时间" prop="foundTime">
          <el-date-picker v-model="form.foundTime" type="datetime" placeholder="选择拾获时间" style="width: 100%" />
        </el-form-item>
        <el-form-item label="拾获地点" prop="location">
        ...
        <el-form-item label="隐藏特征">
          <el-input v-model="form.hiddenFeature" type="textarea" :rows="3" placeholder="只有认领时才会展示的关键特征，用于防冒领（如卡内姓名、挂饰细节）" />
          <div class="tip">隐藏特征不会在公开页面显示，认领时系统会要求失主回答</div>
        </el-form-item>
        <el-form-item label="物品照片">
          ...
          <div class="upload-tip">含人脸/证件号的照片系统会自动打码提示</div>
        </el-form-item>
...
import { postFound } from '@/api/post'
...
const rules = {
  ...
  location: [{ required: true, message: '请选择拾获地点', trigger: 'change' }],
